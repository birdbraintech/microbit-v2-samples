...
// BIRDBRAIN CHANGE: Set to 1 to enable BLE
...
// BIRDBRAIN CHANGE: Set to 0 since we're not doing pairing
...
// BIRDBRAIN CHANGE: Set this to 1 to make pairing unnecessary
...
// Set '1' to enable.
// BIRDBRAIN CHANGE - Turned this off
